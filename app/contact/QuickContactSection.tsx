      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg p-6 border border-blue-200 shadow-sm">
          <div className="flex items-center mb-4">
            ...
            <div>
              <h4 className="font-bold text-gray-900">Send us a Message</h4>
              <p className="text-blue-600 font-medium">📧 We reply within 24-48 hours</p>
            </div>
          </div>
          <p className="text-gray-600 mb-4 text-sm">Fill out our contact form and we'll get back to you with detailed information.</p>
          <button 
